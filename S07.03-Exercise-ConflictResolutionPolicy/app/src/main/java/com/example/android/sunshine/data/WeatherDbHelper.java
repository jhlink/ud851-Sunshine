...
//  COMP (2) Increment the database version after changing the create table statement
    /*
...
//              COMP (1) Add a UNIQUE constraint on the date column to replace on conflict
