...
//  COMP (5) Create static constant integer values named CODE_WEATHER & CODE_WEATHER_WITH_DATE to
// identify the URIs this ContentProvider can handle
...
//  COMP (6) Write a method called buildUriMatcher where you match URI's to their numeric ID
