...
//  COMP (1) Add a layout called list_item_forecast_today
//  COMP (2) Using ConstraintLayout, implement the today list item layout

//  COMP (4) Create a resources file called bools.xml within the res/values-port directory
//  COMP (5) Within bools.xml in the portrait specific directory, add a bool called use_today_layout
// and set it to false

//  COMP (6) Declare constant IDs for the ViewType for today and for a future day
    private final static int VIEWTYPE_TODAY_ID  = 35;
    private final static int VIEWTYPE_FUTURE_ID  = 55;
...
//      COMP (8) Set mUseTodayLayout to the value specified in resources
    ...
    public ForecastAdapterViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case VIEWTYPE_TODAY_ID:
//      COMP (12) If the view type of the layout is today, use today layout
                view = LayoutInflater
                        .from(mContext)
                        .inflate(R.layout.forecast_list_item, viewGroup, false);
                break;

            case VIEWTYPE_FUTURE_ID:
//      COMP (13) If the view type of the layout is future day, use future day layout
                view = LayoutInflater
                        .from(mContext)
            ...
            default:
//      COMP (14) Otherwise, throw an IllegalArgumentException
...
//      COMP (17) Otherwise, throw an IllegalArgumentException
            throw new IllegalArgumentException();
        }
