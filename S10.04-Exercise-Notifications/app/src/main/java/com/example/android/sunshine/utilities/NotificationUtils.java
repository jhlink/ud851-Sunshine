...
//  COMP (1) Create a constant int value to identify the notification
    private static final int WEATHER_NOTIF_ID = 42;
...
//          COMP (2) Use NotificationCompat.Builder to begin building the notification
...
//          COMP (5) Set the content Intent of the NotificationBuilder
            builder.setContentIntent(resultingIntent);

//          COMP (6) Get a reference to the NotificationManager
            NotificationManager notificationManager = (NotificationManager) context
                    .getSystemService(Context
                    .NOTIFICATION_SERVICE);

//          COMP (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
