...
public class MainActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // COMP (1) Add new Activity called SettingsActivity using Android Studio wizard
        // Do step 2 in SettingsActivity
        // COMP (2) Set setDisplayHomeAsUpEnabled to true on the support ActionBar

        // COMP (6) Launch SettingsActivity when the Settings option is clicked
